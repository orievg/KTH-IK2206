...
public class ForwardServerClientThread extends Thread
{
    ...
    private SessionEncrypter clientSessionEncrypter = null;
    private SessionDecrypter clientSessionDecrypter = null;
    private SessionEncrypter serverSessionEncrypter = null;
    private SessionDecrypter serverSessionDecrypter = null;
    ...
    public void encryptClientSession(SessionEncrypter a, SessionDecrypter b){
        this.clientSessionDecrypter = b;
        this.clientSessionEncrypter = a;
    }
    public void encryptServerSession(SessionEncrypter a, SessionDecrypter b){
        this.serverSessionDecrypter = b;
        this.serverSessionEncrypter = a;
    }
    ...
    public void run() {
        try {
            ...
            //do session encryption and decryption if can
            if (this.clientSessionDecrypter != null) {
                clientIn = this.clientSessionDecrypter.openCipherInputStream(clientIn);
            }
            if (this.clientSessionEncrypter != null) {
                clientOut = this.clientSessionEncrypter.openCipherOutputStream(clientOut);
            }
            if (this.serverSessionDecrypter != null) {
                serverIn = this.serverSessionDecrypter.openCipherInputStream(serverIn);
            }
            if (this.serverSessionEncrypter != null) {
                serverOut = this.serverSessionEncrypter.openCipherOutputStream(serverOut);
            }
